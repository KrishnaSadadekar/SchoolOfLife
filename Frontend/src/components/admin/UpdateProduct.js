...
const UpdateProduct = () => {
    ...
    const [course, setCourse] = useState({ name: '', type: '', description: '', trainer: '', seats: 0, price: 0 });
    ...
    const handleClear = () => {
        ...
        setCourse({ name: '', description: '', seats: 0, price: 0 });  // Set individual fields
        setFile(null);
    ...
    return (
        ...
        <div>
            ...
            <Container className="mt-2 border">
                <Row>
                    <Col md={6}>
                        <h1 className="text-center">Upadate!</h1>
                        <Fragment>
                            <Form onSubmit={handleSubmit} className="mt-3">
                                ...
                                <FormGroup>
                                    ...
                                    <Input
                                        ...
                                        name="courseImage"
                                        type="file"
                                        // value={`./img/course/${course.imgUrl}`}
